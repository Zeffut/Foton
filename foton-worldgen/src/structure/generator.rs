...
use foton_utils::{BlockPos, ChunkPos, Identifier, PackedChunkPos};
...
mod tests {
    ...
    use foton_registry::{init_vanilla_registry, vanilla_biomes};
    use glam::IVec3;
    ...
    fn temp_world_dir(test_name: &str) -> PathBuf {
        let unique = SystemTime::now()
            ...
            .as_nanos();
        temp_dir().join(format!("foton-ring-cache-{test_name}-{unique}"))
    }
