...
use foton_registry::template_pool::{
...
use foton_utils::{BoundingBox, Identifier, Rotation};
use glam::IVec3;
...
mod tests {
    use super::*;
    use foton_registry::structure::DimensionPadding;
    use foton_registry::template_pool::{JigsawBlock, ProcessorList};
