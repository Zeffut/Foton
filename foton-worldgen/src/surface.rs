...
/// The `SurfaceContext` in foton-core populates this and passes it to the generated
...
///
/// Implemented by `SurfaceSystem` in foton-core. The transpiled code calls these
