...
//!
//! Uses the compiled nether density functions from foton-registry. The nether's
...
use foton_utils::climate::{TargetPoint, quantize_coord};
use foton_utils::random::RandomSource;
use foton_utils::random::legacy_random::LegacyRandom;
use foton_worldgen::density_functions::nether::{self, NetherColumnCache, NetherNoises};
use foton_worldgen::noise::{BlendedNoise, NormalNoise};
