...
impl SurfaceRuleTranspiler {
    ...
    ///
    /// Generated code references `ctx: &mut SurfaceRuleContext` from `foton_utils`.
            ...
            SurfaceConditionJson::BiomeIs { biome_is } => {
                ...
                let checks: Vec<_> = biome_is
                    ...
                    .map(|b| {
                        ...
                        quote! { biome_id == foton_registry::RegistryEntry::id(&*foton_registry::vanilla_biomes::#biome_ident) as u16 }
                    })
                    .collect();
