...
pub fn transpile(input: &TranspilerInput) -> TokenStream {
    ...
    quote! {
        ...
        use foton_worldgen::density::spline_eval;
        use foton_worldgen::density::RarityValueMapper;
        use foton_math::{clamp, map_clamped};
        use foton_worldgen::noise::NormalNoise;
        use foton_worldgen::random::{PositionalRandom, RandomSplitter};
