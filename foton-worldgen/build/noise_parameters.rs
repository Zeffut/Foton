...
pub(crate) fn build() -> TokenStream {
    let noise_dir =
        Path::new("../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/noise");
    ...
    stream.extend(quote! {
        ...
        //!
        //! Auto-generated from `foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/noise/*.json`.
