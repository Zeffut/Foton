...
pub(crate) fn build() -> TokenStream {
    ...
    stream.extend(quote! {
        ...
        //!
        //! Auto-generated from foton-worldgen/build_assets/multi_noise_biome_source_parameters.json.
        //! Do not edit manually.

        use foton_registry::biome::BiomeRef;
        use foton_registry::vanilla_biomes;
        use foton_utils::climate::{Parameter, ParameterList, ParameterPoint};
    ...
    for (preset_name, entries) in &presets {
        ...
        stream.extend(quote! {
            ...
            #[doc = #doc_get]
            #[inline]
            pub fn #get_fn(target: &foton_utils::climate::TargetPoint) -> BiomeRef {
                *#static_ident.find_value(target)
            }

            #[doc = #doc_cached]
            #[inline]
            pub fn #get_cached_fn(target: &foton_utils::climate::TargetPoint, cache: &mut Option<usize>) -> BiomeRef {
