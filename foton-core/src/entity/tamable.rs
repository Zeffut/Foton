...
use foton_registry::data_components::vanilla_components::{FOOD, FoodProperties};
use foton_registry::item_stack::ItemStack;
use foton_registry::vanilla_block_tags::BlockTag;
use foton_registry::vanilla_game_rules::SHOW_DEATH_MESSAGES;
use foton_utils::entity_events::EntityStatus;
use foton_utils::locks::SyncMutex;
use foton_utils::types::InteractionHand;
use foton_utils::{BlockPos, UuidExt};
use glam::DVec3;
...
///
/// Vanilla walks it with a set of everything it has seen; Foton keeps the set
...
pub trait TamableAnimal: Animal {
    ...
    /// `EntityReference`; Foton stores the UUID it resolves from.
    ...
    /// `getCombatTracker().getDeathMessage()`. Foton has no combat tracker yet,
