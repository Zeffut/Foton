...
use foton_protocol::packets::game::{AttributeModifierData, AttributeSnapshot};
pub use foton_registry::attribute::AttributeModifierOperation;
use foton_registry::attribute::AttributeRef;
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::{REGISTRY, RegistryEntry, RegistryExt};
...
#[cfg(test)]
mod tests {
    use foton_registry::{REGISTRY, init_vanilla_registry, vanilla_attributes, vanilla_entities};
