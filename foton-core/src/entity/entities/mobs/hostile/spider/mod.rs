...
use foton_registry::vanilla_entity_data::SpiderEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `SpiderEntity`.
unsafe impl DowncastType for SpiderEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/spider");
}
