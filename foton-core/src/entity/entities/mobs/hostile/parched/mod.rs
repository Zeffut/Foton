...
use foton_registry::vanilla_entity_data::ParchedEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `ParchedEntity`.
unsafe impl DowncastType for ParchedEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/parched");
}
