...
use foton_registry::vanilla_entity_data::WitchEntityData;
use foton_registry::{
...
// SAFETY: This key is owned by Foton and uniquely identifies `WitchEntity`.
unsafe impl DowncastType for WitchEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/witch");
}
...
impl WitchEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            // `NearestHealableRaiderTargetGoal`, which Foton does not have.
        }
