...
use foton_registry::vanilla_entity_data::EndermiteEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `EndermiteEntity`.
unsafe impl DowncastType for EndermiteEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/endermite");
}
