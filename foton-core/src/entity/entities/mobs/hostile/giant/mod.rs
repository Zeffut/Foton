...
use foton_registry::vanilla_entity_data::GiantEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `GiantEntity`.
unsafe impl DowncastType for GiantEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/giant");
}
...
impl Entity for GiantEntity {
    ...
    /// Vanilla parity: `Giant` inherits `Mob.addAdditionalSaveData` unchanged,
