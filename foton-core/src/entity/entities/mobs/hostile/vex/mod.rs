...
//! Foton's `PathfinderMob::get_walk_target_value` default only implements
...
use foton_registry::vanilla_entity_data::VexEntityData;
use foton_registry::{sound_events, vanilla_damage_types, vanilla_items};
use foton_utils::locks::SyncMutex;
use foton_utils::uuid_ext::UuidExt as _;
...
// SAFETY: This key is owned by Foton and uniquely identifies `VexEntity`.
unsafe impl DowncastType for VexEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/vex");
}
...
impl VexEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            //
            // TODO: Foton's ignore list is by concrete type, and the witch is
...
impl Mob for VexEntity {
    ...
    ///
    /// Vanilla also calls `populateDefaultEquipmentEnchantments`, which Foton
