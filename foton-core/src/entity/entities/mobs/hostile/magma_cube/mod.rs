...
use foton_registry::vanilla_entity_data::MagmaCubeEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `MagmaCubeEntity`.
unsafe impl DowncastType for MagmaCubeEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/magma_cube");
}
...
impl CubeLike for MagmaCubeEntity {
    ...
    fn set_size(&self, size: i32, update_health: bool) {
        ...
        // which Foton reads straight from the attribute, so the bonus is baked
        // in here instead.
...
mod tests {
    ...
    fn downcast_key_identifies_magma_cube() {
        assert_eq!(
            ...
            DowncastTypeKey::new("foton:entity/magma_cube")
        );
    }
