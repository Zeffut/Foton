...
use foton_registry::vanilla_entity_data::ZombifiedPiglinEntityData;
use foton_registry::{sound_events, vanilla_attributes, vanilla_blocks, vanilla_items};
use foton_utils::locks::SyncMutex;
use foton_utils::{BlockPos, Downcast, DowncastType, DowncastTypeKey, WorldAabb};
use glam::DVec3;
...
unsafe impl DowncastType for ZombifiedPiglinEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/zombified_piglin");
}
