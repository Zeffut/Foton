...
use foton_registry::vanilla_entity_data::GuardianEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `ElderGuardianEntity`.
unsafe impl DowncastType for ElderGuardianEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/elder_guardian");
}
