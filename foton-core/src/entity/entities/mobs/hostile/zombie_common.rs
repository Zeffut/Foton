...
//! Java gets them by inheritance; Foton's zombie, husk, drowned, zombified
...
use foton_registry::{TaggedRegistryExt as _, vanilla_items};
...
/// `CanBreakDoors`, `InWaterTime` and `DrownedConversionTime`; Foton has
