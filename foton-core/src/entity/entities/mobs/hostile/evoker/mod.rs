...
use foton_registry::vanilla_entity_data::EvokerEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `EvokerEntity`.
unsafe impl DowncastType for EvokerEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/evoker");
}
...
impl Entity for EvokerEntity {
    ...
    fn is_allied_to(&self, other: &dyn Entity) -> bool {
        ...
        // Vanilla walks `getRootOwner`; Foton's vex keeps one owner, and a vex
