...
use foton_registry::vanilla_entity_data::CreeperEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `CreeperEntity`.
unsafe impl DowncastType for CreeperEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/creeper");
}
