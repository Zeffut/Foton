...
//!
//! Vanilla puts this in `Squid`, which the glow squid extends. Foton has no
...
use foton_registry::particle_type::{ParticleData, ParticleTypeRef};
...
where
    S: SquidLike + foton_utils::DowncastType + 'static,
{
    SquidHooks {
