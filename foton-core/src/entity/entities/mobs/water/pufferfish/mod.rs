...
use foton_protocol::packets::game::{CGameEvent, GameEventType, SoundSource};
use foton_registry::entity_type::{EntityDimensions, EntityTypeRef};
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_entity_data::PufferfishEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `PufferfishEntity`.
unsafe impl DowncastType for PufferfishEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/pufferfish");
}
...
impl PufferfishEntity {
    ...
    ///
    /// Vanilla refreshes the hitbox from `onSyncedDataUpdated`; Foton has no
