...
use foton_registry::vanilla_entity_data::GlowSquidEntityData;
use foton_registry::{sound_events, vanilla_particle_types};
...
// SAFETY: This key is owned by Foton and uniquely identifies `GlowSquidEntity`.
unsafe impl DowncastType for GlowSquidEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/glow_squid");
}
