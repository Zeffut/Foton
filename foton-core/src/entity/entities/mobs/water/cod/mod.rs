...
//! Foton that swims: it navigates in three dimensions through water, drowns in
...
use foton_registry::vanilla_entity_data::CodEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `CodEntity`.
unsafe impl DowncastType for CodEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/cod");
}
