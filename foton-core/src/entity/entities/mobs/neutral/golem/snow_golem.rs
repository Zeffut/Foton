...
use foton_registry::vanilla_entity_data::SnowGolemEntityData;
use foton_registry::{
...
// SAFETY: This key is owned by Foton and uniquely identifies `SnowGolemEntity`.
unsafe impl DowncastType for SnowGolemEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/snow_golem");
}
