...
use foton_registry::vanilla_entity_data::PolarBearEntityData;
use foton_registry::{sound_events, vanilla_entities};
use foton_utils::locks::SyncMutex;
use foton_utils::{BlockPos, BlockStateId, Downcast as _, DowncastType, DowncastTypeKey, UuidExt};
use glam::DVec3;
...
// SAFETY: This key is owned by Foton and uniquely identifies `PolarBearEntity`.
unsafe impl DowncastType for PolarBearEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/polar_bear");
}
