...
//!
//! Historical note: `GoatAi` used to be the entry below. Foton does have a
...
use foton_registry::data_components::InstrumentComponent;
use foton_registry::data_components::vanilla_components::INSTRUMENT;
use foton_registry::entity_type::{
    EntityAttachmentPoint, EntityAttachments, EntityDimensions, EntityTypeRef,
};
use foton_registry::instrument::InstrumentRef;
use foton_registry::item_stack::ItemStack;
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_block_tags::BlockTag;
use foton_registry::vanilla_entity_data::GoatEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `GoatEntity`.
unsafe impl DowncastType for GoatEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/goat");
}
...
impl GoatEntity {
    ...
    /// behavior when a charging goat hits a wall or an entity. Foton has no
...
impl AgeableMob for GoatEntity {
    ...
    /// `AgeableMob.onSyncedDataUpdated`. Foton folds that refresh into this
