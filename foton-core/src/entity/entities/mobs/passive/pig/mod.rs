...
use foton_registry::pig_sound_variant::{PigAge, PigSoundVariantRef};
use foton_registry::pig_variant::PigVariantRef;
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_entity_data::PigEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `PigEntity`.
unsafe impl DowncastType for PigEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/pig");
}
