...
use foton_registry::vanilla_biome_tags;
use foton_registry::vanilla_entity_data::SheepEntityData;
use foton_registry::vanilla_game_events;
use foton_registry::vanilla_item_tags::ItemTag;
use foton_registry::vanilla_loot_tables;
use foton_registry::{DyeColor, REGISTRY, TaggedRegistryExt, sound_events, vanilla_items};
...
// SAFETY: This key is owned by Foton and uniquely identifies `SheepEntity`.
unsafe impl DowncastType for SheepEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/sheep");
}
