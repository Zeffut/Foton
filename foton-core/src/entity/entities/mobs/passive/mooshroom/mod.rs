...
use foton_registry::data_components::components::SuspiciousStewEffects;
use foton_registry::data_components::vanilla_components::SUSPICIOUS_STEW_EFFECTS;
...
use foton_registry::vanilla_entity_data::MushroomCowEntityData;
use foton_registry::vanilla_game_events;
use foton_registry::vanilla_item_tags::ItemTag;
use foton_registry::vanilla_loot_tables;
use foton_registry::{
...
// SAFETY: This key is owned by Foton and uniquely identifies `MushroomCowEntity`.
unsafe impl DowncastType for MushroomCowEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/mushroom_cow");
}
...
impl MushroomCowEntity {
    ...
    /// `mooshroom/variant` entity-property predicate that Foton's loot `EntityRef`
...
impl Mob for MushroomCowEntity {
    ...
    fn mob_interact(&self, player: &Player, hand: InteractionHand) -> InteractionResult {
        ...
        // spawning particles. Foton's item/block registry has no per-item
...
mod tests {
    ...
    use foton_registry::data_components::components::SuspiciousStewEffect;
    use foton_registry::{RegistryExt, init_vanilla_registry, vanilla_entities};
