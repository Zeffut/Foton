...
//!
//! Foton already had beehives, bee nests, honey levels, comparator output and
...
use foton_registry::blocks::properties::{BlockStateProperties, DoubleBlockHalf};
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::item_stack::ItemStack;
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_block_tags::BlockTag;
use foton_registry::vanilla_entity_data::BeeEntityData;
...
/// vanilla, where an inner class reaches its sibling's fields directly. Foton's
...
// SAFETY: This key is owned by Foton and uniquely identifies `BeeEntity`.
unsafe impl DowncastType for BeeEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/bee");
}
...
impl BeeEntity {
    ...
    /// Foton hands the block entity to a closure rather than returning it,
