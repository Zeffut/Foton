...
//!
//! **Gap**: `Parrot.doPush` stops a parrot shoving players around. Foton
...
use foton_registry::vanilla_entity_data::ParrotEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `ParrotEntity`.
unsafe impl DowncastType for ParrotEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/parrot");
}
