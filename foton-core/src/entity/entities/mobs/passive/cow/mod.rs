...
use foton_registry::cow_sound_variant::CowSoundVariantRef;
use foton_registry::cow_variant::CowVariantRef;
use foton_registry::entity_type::{
    EntityAttachmentPoint, EntityAttachments, EntityDimensions, EntityTypeRef,
};
use foton_registry::item_stack::ItemStack;
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_entity_data::CowEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `CowEntity`.
unsafe impl DowncastType for CowEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/cow");
}
