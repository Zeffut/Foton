...
use foton_registry::vanilla_entity_data::DonkeyEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `DonkeyEntity`.
unsafe impl DowncastType for DonkeyEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/donkey");
}
