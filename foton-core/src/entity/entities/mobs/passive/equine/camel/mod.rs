...
use foton_registry::vanilla_entity_data::CamelEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `CamelEntity`.
unsafe impl DowncastType for CamelEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/camel");
}
