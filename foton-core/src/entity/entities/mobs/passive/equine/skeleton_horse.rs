...
use foton_registry::vanilla_entity_data::SkeletonHorseEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `SkeletonHorseEntity`.
unsafe impl DowncastType for SkeletonHorseEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/skeleton_horse");
}
...
impl SkeletonHorseEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            // `setTrap` adds and removes the trap goal as the flag flips. Foton's
