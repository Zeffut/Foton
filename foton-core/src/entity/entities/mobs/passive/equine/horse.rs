...
use foton_registry::vanilla_entity_data::HorseEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `HorseEntity`.
unsafe impl DowncastType for HorseEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/horse");
}
