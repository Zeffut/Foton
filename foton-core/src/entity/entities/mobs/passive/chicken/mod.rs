...
use foton_registry::chicken_sound_variant::{ChickenAge, ChickenSoundVariantRef};
use foton_registry::chicken_variant::ChickenVariantRef;
use foton_registry::entity_type::{
    EntityAttachmentPoint, EntityAttachments, EntityDimensions, EntityTypeRef,
};
use foton_registry::item_stack::ItemStack;
use foton_registry::sound_event::SoundEventRef;
use foton_registry::vanilla_entity_data::ChickenEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `ChickenEntity`.
unsafe impl DowncastType for ChickenEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/chicken");
}
