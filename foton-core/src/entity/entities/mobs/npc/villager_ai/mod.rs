...
//! construction. Foton instead: hands the tick's context to the job-site
...
use foton_registry::{REGISTRY, TaggedRegistryExt as _, vanilla_entities, vanilla_poi_types};
...
/// the village-center queries Foton does not have. A villager with no bed stands
