...
//! the menu an `Arc<dyn Merchant>`, and a Foton entity has no way to produce an
...
use foton_registry::trading::{MerchantOffer, MerchantOffers};
...
pub struct MerchantState {
    ...
    /// villager which never meets a player never rolls its trades. Foton keeps
