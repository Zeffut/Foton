...
use foton_registry::{vanilla_damage_types, vanilla_entities, vanilla_particle_types};
...
pub(super) trait AbstractWindCharge: Projectile {
    ...
    /// approximating in silence: Foton has no
    ...
    /// keep flying -- and Foton's entity manager only ticks entities in loaded
    /// chunks.
    ...
    ///
    /// Foton reaches this test through `Entity::can_be_hit_by_projectile`,
    ...
    /// gap in Foton's living entities rather than in the charge.
    ...
    fn wind_charge_on_hit_entity(&self, entity: &SharedEntity) {
        ...
        // target the hit actually damaged; Foton has no projectile enchantment
        // dispatch yet.
