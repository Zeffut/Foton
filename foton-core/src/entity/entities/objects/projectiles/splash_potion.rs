...
use foton_registry::vanilla_entity_data::SplashPotionEntityData;
use foton_registry::{vanilla_damage_types, vanilla_items, vanilla_potions};
...
// SAFETY: This key is owned by Foton and uniquely identifies `SplashPotionEntity`.
unsafe impl DowncastType for SplashPotionEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/splash_potion");
}
