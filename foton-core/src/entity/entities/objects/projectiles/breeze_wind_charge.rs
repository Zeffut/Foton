...
use foton_registry::vanilla_entity_data::BreezeWindChargeEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `BreezeWindChargeEntity`.
unsafe impl DowncastType for BreezeWindChargeEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/breeze_wind_charge");
}
