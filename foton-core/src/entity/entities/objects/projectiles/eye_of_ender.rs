...
//! `ServerLevel.findNearestMapStructure`. Foton's structure search
...
use foton_registry::level_events::PARTICLES_EYE_OF_ENDER_DEATH;
use foton_registry::vanilla_entity_data::EyeOfEnderEntityData;
...
unsafe impl DowncastType for EyeOfEnderEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/eye_of_ender");
}
