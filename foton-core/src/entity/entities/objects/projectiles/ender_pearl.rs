...
//!
//! Mirrors vanilla `ThrownEnderpearl` (yarn `EnderPearlEntity`) on the Foton
...
use foton_protocol::packets::game::{RelativeMovement, SoundSource};
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::item_stack::ItemStack;
use foton_registry::items::ItemRef;
use foton_registry::vanilla_entity_data::EnderPearlEntityData;
use foton_registry::vanilla_game_rules::ENDER_PEARLS_VANISH_ON_DEATH;
...
// SAFETY: This key is owned by Foton and uniquely identifies `EnderPearlEntity`.
unsafe impl DowncastType for EnderPearlEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/ender_pearl");
}
