...
use foton_registry::vanilla_entity_data::FireworkRocketEntityData;
use foton_registry::{
...
// SAFETY: This key is owned by Foton and uniquely identifies `FireworkRocketEntity`.
unsafe impl DowncastType for FireworkRocketEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/firework_rocket");
}
...
mod tests {
    ...
    use foton_registry::data_components::components::Fireworks;
    use foton_registry::data_components::vanilla_components::FIREWORKS;
    use foton_registry::item_stack::ItemStack;
