...
// SAFETY: This key is owned by Foton and uniquely identifies `TntMinecartEntity`.
unsafe impl DowncastType for TntMinecartEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/tnt_minecart");
}
