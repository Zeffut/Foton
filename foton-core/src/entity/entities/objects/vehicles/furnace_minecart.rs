...
use foton_registry::vanilla_entity_data::FurnaceMinecartEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `FurnaceMinecartEntity`.
unsafe impl DowncastType for FurnaceMinecartEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/furnace_minecart");
}
