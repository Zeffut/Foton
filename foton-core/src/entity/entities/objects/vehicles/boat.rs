...
use foton_registry::vanilla_entity_data::AbstractBoatEntityData;
...
macro_rules! boat_body {
    ($name:ident, $ride_height:expr, $key:literal) => {
        // SAFETY: This key is owned by Foton and uniquely identifies the type.
        ...
        impl Entity for $name {
            ...
            /// an animal forward again. Foton positions every rider on the
...
boat_body!(BoatEntity, BOAT_RIDE_HEIGHT, "foton:entity/boat");
boat_body!(RaftEntity, RAFT_RIDE_HEIGHT, "foton:entity/raft");
