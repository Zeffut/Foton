...
// SAFETY: This key is owned by Foton and uniquely identifies `ChestMinecartEntity`.
unsafe impl DowncastType for ChestMinecartEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/chest_minecart");
}
...
mod tests {
    ...
    fn chest_minecart_relative_portal_position_resets_forward_offset() {
        ...
        let portal_area = FoundRectangle {
            min_corner: foton_utils::BlockPos::new(10, 64, 20),
            axis1_size: 4,
            axis2_size: 5,
        };
