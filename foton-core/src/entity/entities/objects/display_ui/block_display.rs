...
use foton_registry::vanilla_entity_data::BlockDisplayEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `BlockDisplayEntity`.
unsafe impl DowncastType for BlockDisplayEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/block_display");
}
