...
use foton_registry::vanilla_entity_data::ItemEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `ItemEntity`.
unsafe impl DowncastType for ItemEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/item");
}
