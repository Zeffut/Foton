...
use foton_registry::vanilla_entity_data::ExperienceOrbEntityData;
use foton_registry::{vanilla_damage_type_tags, vanilla_entities};
...
// SAFETY: This key is owned by Foton and uniquely identifies `ExperienceOrbEntity`.
unsafe impl DowncastType for ExperienceOrbEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/experience_orb");
}
