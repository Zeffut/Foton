...
use foton_registry::vanilla_entity_data::FallingBlockEntityData;
...
use foton_utils::{BlockPos, BlockStateId, DowncastType, DowncastTypeKey, types::UpdateFlags};
use glam::DVec3;
...
// SAFETY: This Foton-owned key uniquely identifies `FallingBlockEntity`.
unsafe impl DowncastType for FallingBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/falling_block");
}
