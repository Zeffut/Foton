...
//! round-trip beyond the shared base fields, and Foton matches that.

use std::sync::Weak;

use foton_macros::entity_behavior;
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::vanilla_entity_data::MarkerEntityData;
...
// SAFETY: This key is owned by Foton and uniquely identifies `MarkerEntity`.
unsafe impl DowncastType for MarkerEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:entity/marker");
}
...
impl Entity for MarkerEntity {
    ...
    // Foton gets for free: `Entity::hurt` only forwards to living entities.
