...
//! so it deliberately does not sit on Foton's [`TamableAnimal`] layer.
//!
...
use foton_registry::sound_types::SoundType;
...
use foton_utils::locks::{IntoShared as _, Shared, SyncMutex};
use foton_utils::types::InteractionHand;
use foton_utils::{BlockPos, BlockStateId, UuidExt as _};
use glam::DVec3;
...
/// type by reference; `SoundType` is a plain value in Foton's generated registry,
...
pub struct AbstractHorseBase {
    ...
    /// Foton stores the UUID it resolves from, the way [`crate::entity::TamableAnimal`] does.
...
pub trait AbstractHorse: Animal {
    ...
    /// saddle and body armor are equipment, which Foton already drops through
