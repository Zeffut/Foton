...
use foton_registry::vanilla_game_rules::{MOB_GRIEFING, PROJECTILES_CAN_BREAK_BLOCKS};
use foton_registry::{REGISTRY, TaggedRegistryExt as _, vanilla_game_events};
use foton_utils::axis::Axis;
use foton_utils::locks::SyncMutex;
use foton_utils::types::InteractionHand;
use foton_utils::{UuidExt, WorldAabb};
use glam::DVec3;
...
pub trait Projectile: Entity + ProjectileEventSource {
    ...
    /// Sets the owner UUID. Vanilla stores an `EntityReference`; Foton stores the
    ...
    fn projectile_may_interact(&self, world: &World, pos: foton_utils::BlockPos) -> bool {
...
mod tests {
    ...
    use foton_utils::{BlockPos, ChunkPos, Direction, types::UpdateFlags};
