...
use foton_registry::vanilla_game_rules::MOB_DROPS;
use foton_utils::entity_events::EntityStatus;
use foton_utils::locks::SyncMutex;
use foton_utils::types::InteractionHand;
use foton_utils::{BlockPos, Identifier, UuidExt};
...
pub trait Animal: AgeableMob {
    ...
    fn finalize_spawn_child_from_breeding(
        ...
        // opens `Animal.finalizeSpawnChildFromBreeding`. Foton keeps the cause
