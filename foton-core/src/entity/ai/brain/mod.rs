...
/// over the body type so its behaviors can be typed; Foton takes
...
/// a concrete mob downcasts with `foton_utils::Downcast`.
pub struct Brain {
...
impl Brain {
    ...
    /// memories; Foton restores into the brain the mob already built, which
