...
/// Foton keys on the registry path because the type is generic and cannot be
...
macro_rules! memory_module_types {
    ($(
        ...
        ///
        /// Only the memories Foton's ported sensors, behaviors and mobs
...
impl Memories {
    ...
    /// memory -- Foton answers `None` for both "not registered" and "empty",
