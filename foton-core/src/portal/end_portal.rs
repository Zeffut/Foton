...
use foton_utils::{BlockPos, ChunkPos, Direction, SectionPos};
use glam::DVec3;
...
/// Returns the chunks Foton prewarms before creating the End spawn platform.
#[must_use]
...
///
/// TODO(respawn): replace this with the vanilla personal bed/anchor respawn path once Foton has
