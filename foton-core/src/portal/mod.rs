...
//!
//! Vanilla commonly calls loaded worlds "dimensions". Foton uses "world" for
...
///
/// Java stores a reference to the `Portal` block behavior object. Foton keeps a
...
///
/// Vanilla calls these world changes "dimension changes". Foton keeps the
