...
use foton_registry::{blocks::block_state_ext::BlockStateExt, vanilla_blocks, vanilla_entities};
use foton_utils::{BlockLocalAabb, BlockPos, BlockStateId, WorldAabb};
use glam::DVec3;
...
/// Implements `CollisionWorld` for the Foton World struct.
...
mod tests {
    ...
    use super::*;
    use foton_registry::blocks::shapes::VoxelShape;
    use foton_registry::init_vanilla_registry;
    use foton_utils::{BlockLocalAabb, ChunkPos, types::UpdateFlags};
