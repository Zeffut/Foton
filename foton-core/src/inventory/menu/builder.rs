...
//!
//! ```rust
//! use foton_registry::{vanilla_items, vanilla_menu_types};
//! use foton_core::{inventory::menu::kinds::BasicKind, player::player_inventory::PlayerInventory};
//!
//! use foton_core::inventory::prelude::*;
//!
...
impl MenuBuilder {
    ...
    /// ```rust
    /// use foton_core::inventory::prelude::*;
    /// use foton_core::inventory::menu::kinds::BasicKind;
    ///
    ...
    /// use std::sync::Arc;
    ///
    /// use foton_registry::{item_stack::ItemStack, vanilla_items};
...
#[cfg(test)]
mod tests {
    use foton_registry::{init_vanilla_registry, vanilla_items, vanilla_menu_types};
    use foton_utils::{Downcast as _, locks::IntoShared};
