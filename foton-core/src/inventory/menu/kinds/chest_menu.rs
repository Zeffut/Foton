...
use foton_registry::menu_type::MenuTypeRef;
...
/// a `CompoundContainer`. Foton keeps the halves as two independently lockable
...
// within the process.
unsafe impl foton_utils::DowncastType for ChestKind {
    const TYPE_KEY: foton_utils::DowncastTypeKey =
        foton_utils::DowncastTypeKey::new("foton:menu/chest");
}
