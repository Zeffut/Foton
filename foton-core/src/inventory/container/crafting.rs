...
// SAFETY: This key is owned by Foton and uniquely identifies `CraftingContainer`.
unsafe impl DowncastType for CraftingContainer {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:container/crafting");
}
