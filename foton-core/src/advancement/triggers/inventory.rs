...
use foton_registry::advancement::predicate::ItemPredicate;
use foton_registry::advancement::trigger::SlotsPredicate;
...
#[cfg(test)]
mod tests {
    use foton_registry::advancement::predicate::{IntBounds, RegistrySet};
