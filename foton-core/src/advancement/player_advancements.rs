...
use foton_registry::advancement::progress::{AdvancementProgress, CriterionProgress};
use foton_registry::advancement::{Advancement, AdvancementRef};
...
/// Everything Foton remembers about one player's advancements.
...
impl PlayerAdvancements {
    ...
    /// exists for. Foton uses it where vanilla builds a fresh
