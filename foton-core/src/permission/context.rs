...
pub enum PermissionRuleContext {
    ...
    Custom {
        /// Context key owned by Foton or a future plugin.
...
/// Validated Foton domain name used by permission contexts.
...
/// Validated value in Foton's unquoted permission-context expression syntax.
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
impl PermissionContext {
    ...
    ///
    /// World namespaces are Foton domain names, matching command-visible world identifiers.
    ///
    /// # Errors
    ///
