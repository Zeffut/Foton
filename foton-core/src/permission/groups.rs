...
/// administers the server. Foton has permission *expressions* rather than
    ...
    fn default() -> Self {
        ...
        groups.insert(
            ...
            PermissionGroupConfig {
                ...
                // These are the Foton commands above that line: `stop` and
                // `operator` are vanilla level 4 and 3, and `perms` and
                // `domain` are Foton's own administration tools.
                deny: vec![
