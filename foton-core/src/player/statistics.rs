...
use foton_protocol::packets::game::CAwardStats;
use foton_registry::stat::{CustomStatRef, Stat, StatTypeRef};
use foton_registry::{RegistryEntry, vanilla_custom_stats};
...
impl Player {
    ...
    /// way `ServerPlayer.awardStat` does. Foton has no statistic-keyed
