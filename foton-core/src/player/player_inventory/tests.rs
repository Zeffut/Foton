...
impl_test_menu_kind_downcast!(
    CloseOnTick,
    "foton:test/menu/player_inventory/close_on_tick"
);
...
impl_test_menu_kind_downcast!(
    CloseOnClick,
    "foton:test/menu/player_inventory/close_on_click"
);
...
impl_test_menu_kind_downcast!(
    CloseOnOpen,
    "foton:test/menu/player_inventory/close_on_open"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/reopen_same_container_on_open"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/open_replacement_on_open"
);
...
impl_test_menu_kind_downcast!(
    ReopenOnRemoved,
    "foton:test/menu/player_inventory/reopen_on_removed"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/queue_drained_replacement_then_remove_all_on_open"
);
...
impl_test_menu_kind_downcast!(
    DropAllMenusOnOpen,
    "foton:test/menu/player_inventory/drop_all_menus_on_open"
);
...
impl_test_menu_kind_downcast!(
    RemoveAllOnRemoved,
    "foton:test/menu/player_inventory/remove_all_on_removed"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/open_terminal_replacement_on_removed"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/queue_replacement_on_open_and_remove_all_on_removed"
);
...
impl_test_menu_kind_downcast!(
    CountRemovals,
    "foton:test/menu/player_inventory/count_removals"
);
...
impl_test_menu_kind_downcast!(
    ...
    "foton:test/menu/player_inventory/block_terminal_menu_removal"
);
