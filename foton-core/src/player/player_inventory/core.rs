...
use foton_registry::{enchantment_effect::EnchantmentEffectComponent, item_stack::ItemStack};
...
// SAFETY: This key is owned by Foton and uniquely identifies `PlayerInventory`.
unsafe impl DowncastType for PlayerInventory {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:container/player_inventory");
}
