...
use foton_registry::data_components::components::PiercingWeapon;
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::item_stack::ItemStack;
use foton_registry::sound_event::{SoundEventHolder, SoundEventRef};
use foton_registry::{REGISTRY, vanilla_attributes, vanilla_damage_types, vanilla_entities};
use foton_utils::types::{Difficulty, GameType, InteractionHand};
use foton_utils::{BlockPos, Downcast as _, Identifier, WorldAabb};
use glam::DVec3;
