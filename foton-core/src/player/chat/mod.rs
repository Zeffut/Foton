...
impl Player {
    ...
    const fn should_disconnect_for_rate_spam(
        ...
        throttler.increment();
        // TODO: Also exempt the singleplayer owner once Foton models that state.
