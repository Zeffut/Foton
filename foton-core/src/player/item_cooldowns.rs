use foton_protocol::packets::game::CCooldown;
use foton_registry::data_components::vanilla_components::USE_COOLDOWN;
...
#[cfg(test)]
mod tests {
    use foton_registry::data_components::vanilla_components::{USE_COOLDOWN, UseCooldown};
    use foton_registry::item_stack::ItemStack;
    ...
    fn explicit_group_is_shared_between_items() {
        ...
        let group = foton_utils::Identifier::vanilla_static("test_group");
