...
use foton_registry::stat::{Stat, StatValueRegistry};
use foton_registry::{REGISTRY, RegistryEntry as _, RegistryExt as _};
...
///
/// This is Foton's runtime save snapshot. Vanilla import/export should live outside
...
pub struct PersistentPlayerData {
    ...
    /// one world; Foton scopes it to the domain, beside the experience and the
...
///
/// Vanilla dispatches on the stat type's own registry; Foton names the four
