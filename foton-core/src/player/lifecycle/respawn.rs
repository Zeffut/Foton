...
use foton_protocol::packets::game::{CSound, SoundSource};
...
impl Player {
    ...
    fn reset_state_for_death_respawn_inner(&self, pending_token: Option<PendingWorldChangeToken>) {
        ...
        // whose `DATA_PLAYER_ABSORPTION_ID` starts at zero. Foton reuses the
    ...
    /// Foton's death-processed guard is not respawn authority.
    #[must_use]
