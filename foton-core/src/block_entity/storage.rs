...
use foton_utils::{BlockPos, BlockStateId, locks::SyncRwLock};
...
mod tests {
    ...
    use foton_utils::{DowncastType, DowncastTypeKey, locks::SyncMutex};
    ...
    unsafe impl DowncastType for ReentrantLifecycleBlockEntity {
        const TYPE_KEY: DowncastTypeKey =
            DowncastTypeKey::new("foton:test/block_entity/reentrant_lifecycle");
    }
