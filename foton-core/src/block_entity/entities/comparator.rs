...
// SAFETY: This key is owned by Foton and uniquely identifies `ComparatorBlockEntity`.
unsafe impl DowncastType for ComparatorBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/comparator");
}
