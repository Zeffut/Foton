...
use foton_registry::block_entity_type::BlockEntityType;
...
// SAFETY: This key is owned by Foton and uniquely identifies `DispenserBlockEntity`.
unsafe impl DowncastType for DispenserBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/dispenser");
}
...
unsafe impl DowncastType for DispenserContainer {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:container/dispenser");
}
