...
// SAFETY: This key is owned by Foton and uniquely identifies `EndGatewayBlockEntity`.
unsafe impl DowncastType for EndGatewayBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/end_gateway");
}
