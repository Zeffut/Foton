...
use foton_registry::blocks::properties::{BlockStateProperties, Direction, PistonType};
...
// SAFETY: This key is owned by Foton and uniquely identifies `PistonMovingBlockEntity`.
unsafe impl DowncastType for PistonMovingBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/piston_moving");
}
...
mod tests {
    ...
    use foton_utils::{ChunkPos, types::GameType};
    use glam::DVec3;
