...
//!
//! Foton's worldgen already reads all of this out of the *template* copies of
...
unsafe impl DowncastType for JigsawBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/jigsaw");
}
...
mod tests {
    ...
    use foton_registry::blocks::properties::FrontAndTop;
