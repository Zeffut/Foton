...
unsafe impl DowncastType for ChiseledBookShelfBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/chiseled_bookshelf");
}
...
unsafe impl DowncastType for ChiseledBookShelfContainer {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:container/chiseled_bookshelf");
}
