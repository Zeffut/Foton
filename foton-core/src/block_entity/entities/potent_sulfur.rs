...
use foton_registry::blocks::properties::{BlockStateProperties, PotentSulfurState};
...
use foton_utils::random::{PositionalRandom, Random, RandomSource, RandomSplitter};
...
// SAFETY: This key is owned by Foton and uniquely identifies `PotentSulfurBlockEntity`.
unsafe impl DowncastType for PotentSulfurBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:block_entity/potent_sulfur");
}
