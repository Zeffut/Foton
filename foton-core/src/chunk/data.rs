...
impl Chunk {
    ...
    fn commit_pending_creation(
        ...
        let BlockEntityCreation::Created(block_entity) = creation else {
            // Proto chunks retain markers for both intentional null factories and Foton's
...
mod tests {
    ...
    use foton_utils::{BlockPos, ChunkPos, DowncastType, DowncastTypeKey, types::UpdateFlags};
    ...
    unsafe impl DowncastType for DropSentinel {
        const TYPE_KEY: DowncastTypeKey =
            DowncastTypeKey::new("foton:test/chunk/transient_generation_state");
    }
    ...
    fn dummy_factory_outcomes_keep_proto_and_full_stage_semantics() {
        ...
        // A block whose vanilla block entity type exists but has no Foton factory
