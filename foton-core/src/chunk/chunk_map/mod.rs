...
use foton_utils::{BlockPos, BlockStateId, ChunkPos, PackedChunkPos, SectionPos, locks::SyncMutex};
...
/// membership-changing lifecycle boundary. This is also Foton's documented
...

        {
            ...
            if !tickable_chunks.block.is_empty() {
                ...
                if random_tick_speed > 0 {
                    // Intentional Foton difference: this uses Vanilla's coordinate LCG,
