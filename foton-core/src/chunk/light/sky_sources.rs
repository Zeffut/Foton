use foton_registry::{blocks::block_state_ext::BlockStateExt, vanilla_blocks};
use foton_utils::{BlockStateId, Direction, SectionPos};
...
///
/// Vanilla stores this in a 256-entry `SimpleBitStorage`. Foton keeps absolute
