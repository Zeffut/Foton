...
use foton_registry::feature::FluidStateData;
use foton_registry::structure::TerrainAdjustment;
use foton_registry::{vanilla_blocks, vanilla_fluids};
use foton_utils::random::{Random as _, worldgen_random::WorldgenRandom};
use foton_utils::{BlockPos, BoundingBox, ChunkPos, Identifier};
...
use foton_registry::feature::ConfiguredFeatureKind;
use foton_registry::{REGISTRY, init_vanilla_registry, vanilla_configured_features};
...
fn feature_direction_order_matches_java_direction_values() {
    assert_eq!(
        ...
        [
            foton_utils::Direction::Down,
            foton_utils::Direction::Up,
            foton_utils::Direction::North,
            foton_utils::Direction::South,
            foton_utils::Direction::West,
            foton_utils::Direction::East,
        ]
    );
}
