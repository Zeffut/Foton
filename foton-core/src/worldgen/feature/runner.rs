...
use foton_utils::{BoundingBox, ChunkPos};
use glam::IVec3;
...
#[cfg(test)]
use foton_worldgen::structure::StructureReferenceMap;
...
impl FeatureDecorationRunner {
    ...
    pub(super) fn resolve_structure_starts_from_references(
        ...
        mut start_lookup: impl FnMut(foton_utils::ChunkPos, &Identifier) -> Option<StructureStart>,
    ) -> Vec<StructureStart> {
    ...
    pub(super) fn place_features_for_step(
        ...
        for feature_index in feature_indices {
            ...
            match feature {
                ...
                // and the only one Foton builds carries no placement modifiers
                // at all.
