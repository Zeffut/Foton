...
use foton_worldgen::density::DimensionNoises;
use foton_worldgen::surface::{SurfaceConditionNoiseCache, SurfaceRuleContext};
use glam::IVec3;
...
use foton_worldgen::noise::{Aquifer, AquiferResult};
...
///
/// Vanilla tests a block-state predicate for every candidate block. Foton's
