...
use foton_registry::structure::{DimensionPadding, LiquidSettingsData};
use foton_registry::template_pool::{TemplateData, TemplatePoolData};
use foton_registry::vanilla_template_pools::{vanilla_template_pools, vanilla_templates};
use foton_utils::random::legacy_random::LegacyRandom;
use foton_utils::random::worldgen_random::WorldgenRandom;
use foton_utils::{BlockPos, BoundingBox, Identifier};
use foton_worldgen::structure::jigsaw::{JigsawPlacement, MaxDistance, assemble};
use glam::IVec3;
...
pub(crate) fn generate_jigsaw(
    ...
    // Vanilla passes `BoundingBox.infinite()`; Foton's placement always clips to
