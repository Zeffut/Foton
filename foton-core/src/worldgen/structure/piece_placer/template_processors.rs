...
use foton_registry::structure::{OceanRuinBiomeTempData, RuinedPortalPlacementData};
...
use foton_worldgen::structure::{RuinedPortalProperties, TemplateProcessorList};
