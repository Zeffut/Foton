...
use foton_registry::structure::RuinedPortalPlacementData;
...
use foton_utils::{BlockPos, BoundingBox, Direction, types::UpdateFlags};

use crate::chunk::heightmap::HeightmapType;
use crate::world::WorldGenLevel;
use foton_worldgen::structure::RuinedPortalProperties;
