...
use foton_registry::template_pool::{TemplateData, TemplatePoolData};
use foton_registry::{REGISTRY, RegistryExt, vanilla_biomes, vanilla_blocks};
...
use foton_worldgen::structure::{ColumnBlock, StructureGenerationContext};
...
impl FlatChunkGenerator {
    ...
    /// `null` into its layer list for those; Foton writes air, which the layer
