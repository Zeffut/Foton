...
use foton_registry::blocks::shapes::is_shape_full_block;
use foton_registry::entity_type::EntityTypeRef;
use foton_registry::fluid::{is_lava_fluid, is_water_fluid};
...
/// satisfies just as well as a running world. Foton's `World` and its
...
/// including the mobs Foton has yet to implement. Listing them all now means a
...
/// the default here, because Foton's block behaviors have no such hook yet.
...
/// keep mobs out of a running circuit. Foton keeps that answer on the block
