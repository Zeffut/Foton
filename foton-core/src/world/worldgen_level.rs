...
/// both implement. Foton mirrors it for the same reason vanilla has it: bone meal on
...
pub(crate) trait WorldGenLevel: LevelAccessor {
    ...
    ///
    /// Vanilla loads the tag into the block entity `setBlock` just created. Foton's
