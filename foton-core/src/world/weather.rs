...
impl World {
    ...
    ///
    /// Vanilla reads this attribute at a block position. Foton resolves
    ...
    /// attribute.
    ///
    /// Vanilla reads this attribute at the cat's position; Foton resolves
    ...
    /// cannot change the answer and Foton resolves it per dimension.
    ...
    ///
    /// Vanilla reads this attribute at a block position; Foton resolves environment
    ...
    /// `if_unset` is that fallback. Vanilla reads it at a block position; Foton
    ...
    /// Vanilla reads it at a position; Foton resolves environment attributes per
    ...
    ///
    /// Live worlds use the motion-blocking heightmap until Foton has a full
