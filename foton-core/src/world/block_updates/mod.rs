...
impl World {
    ...
    ///
    /// Live gameplay callers must run in Foton's serialized world-mutation phase. Palette and
    ...
    /// Foton intentionally never synchronously loads the second neighbor chunk:
