...
use foton_registry::timeline::{Ease, KeyframeValue, TimelineRef, Track};
...
/// `visual/cloud_color`'s alpha the way `Entity.isInClouds` gates on it. Foton
...
mod tests {
    ...
    use foton_registry::vanilla_dimension_types::{OVERWORLD, THE_NETHER};
    use foton_registry::vanilla_world_clocks;
