...
use foton_registry::{REGISTRY, RegistryEntry as _, RegistryExt as _, vanilla_game_events};
...
///
/// Vanilla keeps an identity map from game event to frequency. Foton indexes the same
