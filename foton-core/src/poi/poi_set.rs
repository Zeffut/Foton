...
use foton_utils::PackedSectionBlockPos;
...
///
/// Uses a section-relative packed block position as the key, with a secondary
/// index by POI type for type-filtered queries.
