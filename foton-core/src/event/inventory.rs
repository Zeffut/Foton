...
pub struct InventoryClickEvent { player_id: Uuid, current_item: Option<ItemStack>, click: String, cancelled: bool }
...
impl InventoryClickEvent {
    ...
    pub fn new(player_id: Uuid, current_item: Option<ItemStack>, click: String) -> Self {
        Self { player_id, current_item, click, cancelled: false }
    }
    ...
    pub fn click(&self) -> &str { &self.click }
