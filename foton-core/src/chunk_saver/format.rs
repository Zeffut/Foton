...
use foton_utils::{BoundingBox, Identifier, PackedChunkPos};
use glam::IVec3;
...
pub struct PersistentChunk<'a> {
    ...
    /// Proto chunk carving mask as Foton's packed bitset layout.
...
/// Foton stores entities inline with chunk data for simplicity.
...
/// Foton-native persistent state for a jigsaw pool piece.
#[derive(SchemaWrite, SchemaRead)]
