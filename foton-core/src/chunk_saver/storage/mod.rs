...
use foton_worldgen::structure::desert_pyramid::DesertPyramidPieceData;
use foton_worldgen::structure::fortress::FortressPieceData;
use foton_worldgen::structure::jigsaw::{JigsawJunction, JigsawPieceData};
use foton_worldgen::structure::jungle_temple::JungleTemplePieceData;
use foton_worldgen::structure::mineshaft::{
...
use foton_worldgen::structure::stronghold::{StrongholdPieceData, StrongholdSmallDoorType};
