...
///
/// Foton gap: Vanilla hands the new arrow the stack it came from, so the arrow
...
/// one.
///
/// Foton deviation: an arrow type Foton has no entity factory for also falls
/// back to the plain arrow. Building an entity Foton cannot reload would lose
