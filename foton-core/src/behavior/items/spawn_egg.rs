...
use foton_registry::data_components::components::EntityData;
use foton_registry::data_components::vanilla_components::{CUSTOM_NAME, ENTITY_DATA};
...
impl SpawnEggItem {
    ...
    pub fn spawn_offspring_from_spawn_egg(
        ...
        // Vanilla asks an `AgeableMob` for its `getBreedOffspring`; Foton hangs
...

        {
            ...
            // entity means `CUSTOM_NAME` and `CUSTOM_DATA`. Foton entities have no
