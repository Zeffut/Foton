...
pub struct StandingAndWallBlockItem {
    ...
    #[json_arg(
        r#enum = "Direction",
        module = "foton_registry::blocks::properties",
...
impl StandingAndWallBlockItem {
    ...
    #[must_use]
    pub fn get_block_for_state(&self, state: foton_utils::BlockStateId) -> BlockRef {
...
impl ItemBehavior for StandingAndWallBlockItem {
    ...
    /// `getPlacementState`; the rest of `BlockItem.place` runs unchanged. Foton
