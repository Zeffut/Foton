...
use foton_registry::data_components::vanilla_components::DEBUG_STICK_STATE;
...
///
/// Foton deviation: Vanilla holds a typed `Property<T>` and calls
/// `state.setValue`. Foton's properties are only object-safe through their
