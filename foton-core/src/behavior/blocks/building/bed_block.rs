...
use foton_registry::blocks::properties::{BedPart, BoolProperty, EnumProperty};
...
use foton_registry::{vanilla_blocks, vanilla_damage_types};
...
mod tests {
    ...
    ///
    /// The note that stood here said this needed a `World::explode` Foton did
    ...
    fn a_bed_used_where_beds_explode_takes_the_room_with_it() {
        ...
        use foton_utils::{ChunkPos, types::InteractionHand};
