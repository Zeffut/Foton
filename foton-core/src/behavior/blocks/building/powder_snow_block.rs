...
use foton_registry::blocks::{BlockRef, block_state_ext::BlockStateExt as _, shapes::VoxelShape};
...
use foton_utils::{BlockLocalAabb, BlockPos, BlockStateId};
use glam::DVec3;
...
///
/// Vanilla handles several powder-snow collision variants in one class; Foton
...
mod tests {
    ...
    use foton_registry::{init_vanilla_registry, sound_events, vanilla_blocks, vanilla_entities};
