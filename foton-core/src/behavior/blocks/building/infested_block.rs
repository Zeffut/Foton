...
use foton_registry::blocks::properties::{BlockStateProperties, EnumProperty};
use foton_registry::item_stack::ItemStack;
use foton_registry::vanilla_enchantment_tags::EnchantmentTag;
use foton_registry::vanilla_game_rules::BLOCK_DROPS;
use foton_registry::{REGISTRY, RegistryExt as _, TaggedRegistryExt as _, vanilla_entities};
...
///
/// Vanilla keeps the host pairing on the `InfestedBlock` class itself; Foton
...
/// populates as the blocks register. Foton builds it once on first use by
