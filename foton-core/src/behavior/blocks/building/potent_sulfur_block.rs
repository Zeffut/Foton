...
use foton_registry::blocks::properties::{BlockStateProperties, EnumProperty, PotentSulfurState};
...
use foton_utils::{BlockPos, BlockStateId, Direction, Downcast as _};
...
impl BlockBehavior for PotentSulfurBlock {
    ...
    // TODO: Implement vanilla animateTick once Foton has client-side ambient tick/particle support:
