...
use foton_registry::blocks::properties::{BlockStateProperties, EnumProperty, IntProperty};
use foton_utils::{BlockStateId, Direction};
...
mod tests {
    ...
    use foton_utils::{BlockPos, types::InteractionHand};
    use glam::DVec3;
