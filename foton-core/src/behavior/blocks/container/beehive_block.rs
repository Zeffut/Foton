...
use foton_utils::{BlockPos, BlockStateId, Downcast as _, WorldAabb};
...
/// Foton has no loot tables, so the number is written out.
...
impl BlockBehavior for BeehiveBlock {
    ...
    fn use_item_on(
        ...
        // TODO: Award stat ITEM_USED; Foton has no statistics registry.
