...
use foton_registry::{REGISTRY, level_events, vanilla_block_entity_types, vanilla_blocks};
...
/// trigger. Foton has neither a per-target stack limit reachable from here nor
