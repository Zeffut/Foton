//! TNT block behavior.
//!
//! Vanilla parity: `TntBlock`. A redstone signal, flint and foton, a fire
...
use foton_registry::{sound_events, vanilla_blocks, vanilla_items};
use foton_utils::{
...
impl BlockBehavior for TntBlock {
    ...
    /// Lights the TNT with flint and foton or a fire charge.
    ///
    ...
    fn use_item_on(
        ...
        match igniter {
            // Flint and foton wears out; a fire charge is spent.
