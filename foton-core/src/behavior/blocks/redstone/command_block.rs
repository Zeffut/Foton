...
use foton_protocol::packets::game::CBlockEntityData;
use foton_registry::RegistryEntry as _;
use foton_registry::blocks::BlockRef;
use foton_registry::blocks::block_state_ext::BlockStateExt as _;
use foton_registry::blocks::properties::EnumProperty;
use foton_registry::blocks::properties::{BlockStateProperties, Direction};
use foton_registry::vanilla_game_rules::{COMMAND_BLOCKS_WORK, MAX_COMMAND_SEQUENCE_LENGTH};
...
impl BlockBehavior for CommandBlock {
    ...
    /// both when the placed item carried block-entity data. Foton's placement
