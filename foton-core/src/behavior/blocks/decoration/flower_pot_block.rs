...
use foton_registry::{REGISTRY, RegistryExt as _, vanilla_blocks, vanilla_game_events};
...
///
/// Vanilla builds this in `FlowerPotBlock`'s constructor; Foton builds it once
