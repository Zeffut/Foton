...
impl TurtleEggBlock {
    ...
    ///
    /// Vanilla writes `entity instanceof Zombie`. Foton has no entity class
    ...
    /// attribute at the egg's position. Foton resolves environment attributes
...
mod tests {
    ...
    fn a_hatched_egg_leaves_a_baby_turtle_that_remembers_the_nest() {
        ...
        let search = foton_utils::WorldAabb::new(7.0, 63.0, 7.0, 10.0, 66.0, 10.0);
