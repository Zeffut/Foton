...
//! Foton resolves the same three cases -- default, sculk, sculk vein -- from block identity
...
//! Foton's `push_entities_up` needs a live `World` to query entities, which this shared walk
