...
use super::{
    ...
    EntryAction, ExecutionCommandSource, ExecutionControl, ExecutionStop, FotonCommandRuntime,
    FotonContextChain, Frame, argument, literal,
};
...
fn register(
    ...
    builder: CommandNodeBuilder<TestSource, FotonCommandRuntime>,
) -> NodeId {
...
impl CustomCommandExecutor<TestSource> for FrameReturnExecutor {
    fn run(
        ...
        _chain: &FotonContextChain<TestSource>,
...
impl CustomModifierExecutor<TestSource> for ReturningModifier {
    fn apply(
        ...
        chain: &FotonContextChain<TestSource>,
