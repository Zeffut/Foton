...
use foton_utils::{DowncastType, DowncastTypeKey, translations};
...
unsafe impl DowncastType for GameProfileArgument {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:command/value/game_profile");
}
...
unsafe impl DowncastType for GameProfileParser {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:command/parser/game_profile");
}

impl FotonArgumentParser for GameProfileParser {
