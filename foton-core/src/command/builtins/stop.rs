use foton_utils::{Identifier, translations::COMMANDS_STOP_STOPPING};
use text_components::TextComponent;

use super::super::{
    brigadier::{CommandNodeBuilder, CommandSyntaxError},
    execution::{CommandSource, FotonCommandContext, FotonCommandRuntime, literal},
...
fn stop_server(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
    context
        .source()
