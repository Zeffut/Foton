...
use foton_registry::{vanilla_entities, vanilla_mob_effects};
...
fn start_raid(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
...
fn stop_raid(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
...
fn check_raid(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
    let Some(raid) = raid_here(context)? else {
        context
            .source()
...
fn set_omen(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
...
fn glow_raiders(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
    let Some(raid) = raid_here(context)? else {
        return Ok(1);
    };
    let world = context.source().world();
...
fn spawn_leader(context: &FotonCommandContext<CommandSource>) -> Result<i32, CommandSyntaxError> {
    let world = context.source().world();
