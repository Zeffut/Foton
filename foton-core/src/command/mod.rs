...
use self::{
    ...
    execution::{CommandSource as InternalCommandSource, FotonCommandRuntime},
};
use crate::command::brigadier::CommandSyntaxError;
use crate::{player::Player, world::World};

pub(crate) type CommandDispatcher =
    BrigadierCommandDispatcher<InternalCommandSource, FotonCommandRuntime>;
...
/// Projects Foton capabilities onto vanilla's shared gamemaster client affordance.
