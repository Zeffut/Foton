...
use foton_registry::packets::play::{C_MOVE_ENTITY_POS, C_MOVE_ENTITY_POS_ROT, C_MOVE_ENTITY_ROT};
...
impl foton_utils::serial::WriteTo for PackedEntityDelta {
    fn write(&self, writer: &mut impl Write) -> io::Result<()> {
        foton_utils::serial::WriteTo::write(&self.0, writer)
    }
}
