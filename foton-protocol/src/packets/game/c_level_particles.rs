...
use foton_registry::{packets::play::C_LEVEL_PARTICLES, particle_type::ParticleData};
...
mod tests {
    ...
    use foton_registry::{RegistryEntry, vanilla_particle_types};
    ...
    fn writes_fields_in_vanilla_wire_order() {
        ...
        let packet = CLevelParticles {
            ...
            max_speed: 0.125,
            count: -7,
            particle: foton_registry::particle_type::ParticleData::simple(
