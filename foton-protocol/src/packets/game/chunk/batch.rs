use foton_macros::{ClientPacket, ReadFrom, ServerPacket, WriteTo};
#[expect(unused_imports)]
use foton_registry::packets::play::S_CHUNK_BATCH_RECEIVED;
use foton_registry::packets::play::{C_CHUNK_BATCH_FINISHED, C_CHUNK_BATCH_START};
