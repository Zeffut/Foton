...
use foton_registry::packets::play::S_CHAT_COMMAND;
...
impl foton_utils::serial::ReadFrom for ArgumentSignature {
    fn read(reader: &mut Cursor<&[u8]>) -> std::io::Result<Self> {
...
impl foton_utils::serial::ReadFrom for LastSeenMessagesUpdate {
    fn read(reader: &mut Cursor<&[u8]>) -> std::io::Result<Self> {
