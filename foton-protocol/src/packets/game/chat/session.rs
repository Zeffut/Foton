...
/// The full version with validated keys lives in foton-core.
#[derive(Clone, Debug)]
...
impl foton_utils::serial::WriteTo for ProtocolRemoteChatSessionData {
...
impl foton_utils::serial::ReadFrom for SChatSessionUpdate {
