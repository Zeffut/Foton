...
def render_sounds(found):
    lines = [
        ...
        " *",
        " * Keyed, because Bukkit's Sound is: a plugin calling getKey() expects a",
        " * NamespacedKey, and Registry.SOUNDS cannot exist without it. The raw",
        " * string the registry stores is still reachable through key().",
        " */",
    ...
    lines += [
        ...
        "    }",
        "",
        "    /** The registry string, namespace included. */",
        "    public String key() {",
        "        return key;",
        "    }",
        "",
