...
for test in dev/join-test.sh dev/selector-test.sh dev/rcon-test.sh \
           dev/summon-test.sh dev/sapling-test.sh dev/bonemeal-test.sh \
           dev/container-test.sh dev/store-entity-test.sh \
           dev/function-test.sh \
           dev/items-test.sh dev/bossbar-test.sh \
            ...
            dev/enderman-block-test.sh dev/dispenser-test.sh \
            dev/scaffolding-test.sh dev/eyeblossom-test.sh \
            ...
            dev/jigsaw-test.sh dev/locate-biome-test.sh \
            dev/flat-features-test.sh \
            ...
            dev/player-state-test.sh dev/advancement-test.sh dev/statistics-test.sh; do
  name=$(basename "$test")
