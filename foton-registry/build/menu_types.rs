...
pub(crate) fn build() -> TokenStream {
    ...
    let menu_types: Vec<ExtractedMenuType> = serde_json::from_str(&content)
    ...
    for menu_type in &menu_types {
        let menu_type_name = &menu_type.name;
        ...
        let slot_count = menu_type.slot_count;
