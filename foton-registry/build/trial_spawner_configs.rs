...
//! `foton-registry/src/trial_spawner_config.rs`.
...
const CONFIG_DIR: &str = "../foton-utils/build_assets/builtin_datapacks/minecraft/trial_spawner";
...
///
/// Mirrors the naming in `foton-registry/build/loot_tables/mod.rs`.
...
/// number a double and a boolean a byte. Foton's entity loaders read typed
