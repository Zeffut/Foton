...
use foton_utils::value_providers::{
    FloatProvider, HeightProvider, IntProvider, UniformIntProvider, VerticalAnchor,
    WeightedIntProvider,
};
use foton_utils::{Direction, Identifier, Rotation};
...
pub(crate) fn build_configured() -> TokenStream {
    let dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/configured_feature";
...
pub(crate) fn build_placed() -> TokenStream {
    let dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/placed_feature";
    println!("cargo:rerun-if-changed={dir}");
