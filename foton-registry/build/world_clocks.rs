#![expect(
    clippy::unwrap_used,
    reason = "build script must fail immediately on invalid extracted world clock data"
)]
...
pub(crate) fn build() -> TokenStream {
    let world_clock_dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/world_clock";
