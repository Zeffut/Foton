...
//! `foton-utils/build_assets/builtin_datapacks/minecraft/`.
//!
...
const TRADE_DIR: &str = "../foton-utils/build_assets/builtin_datapacks/minecraft/villager_trade";
const TRADE_SET_DIR: &str = "../foton-utils/build_assets/builtin_datapacks/minecraft/trade_set";
const TRADE_TAG_DIR: &str =
    "../foton-utils/build_assets/builtin_datapacks/minecraft/tags/villager_trade";
    ...
    let components = match &cost.components {
        ...
        Some(components) => {
            ...
            assert!(
                ...
                "trade cost component `{key}` is not modeled; Foton has no \
