...
pub(crate) fn build() -> TokenStream {
    let pool_dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/template_pool";
    let structure_dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/structure";
    ...
    for (name, tmpl) in &templates {
        ...
        let include_path = format!(
            "../../../foton-utils/build_assets/builtin_datapacks/minecraft/structure/{name}.nbt"
        );
