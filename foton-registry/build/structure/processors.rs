...
use foton_utils::{Identifier, value_providers::IntProvider};
    ...
    match provider {
        ...
        IntProvider::WeightedList { distribution } => {
            let distribution = generate_vec(distribution, |entry| {
                ...
                quote! { foton_utils::value_providers::WeightedIntProvider { data: #data, weight: #weight } }
            });
...
pub(crate) fn build() -> TokenStream {
    let dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/processor_list";
