...
fn load_biome_tags() -> HashMap<String, Vec<String>> {
    let tag_base = "../foton-utils/build_assets/builtin_datapacks/minecraft/tags/worldgen/biome";
...
fn parse_max_distance(value: &serde_json::Value, context: &str) -> i32 {
    ...
    panic!(
        "Unsupported max_distance_from_center object in {context}; Foton currently stores one distance for both axes: {value}"
    );
}
...
fn load_structure_data(
    ...
    let structure_dir =
        "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/structure";
...
pub(crate) fn build_structures() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/structure/"
    );
    println!(
        "cargo:rerun-if-changed=../foton-utils/build_assets/builtin_datapacks/minecraft/tags/worldgen/biome/"
    );
...
pub(crate) fn build() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/structure_set/"
    );
    println!(
        "cargo:rerun-if-changed=../foton-utils/build_assets/builtin_datapacks/minecraft/tags/worldgen/biome/"
    );
    ...
    let set_dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/structure_set";
