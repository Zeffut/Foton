...
//! deserialises each via `foton_utils::value_providers` types, and emits
//! Rust source with a `pub static` per carver plus a `register_carvers` fn.

use std::fs;

use foton_utils::Identifier;
use foton_utils::value_providers::{FloatProvider, HeightProvider, VerticalAnchor};
...
pub(crate) fn build() -> TokenStream {
    let dir = "../foton-utils/build_assets/builtin_datapacks/minecraft/worldgen/configured_carver";
