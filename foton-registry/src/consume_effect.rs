...
use foton_utils::{Downcast as _, DowncastType, DowncastTypeKey, ErasedType, Identifier};
...
// SAFETY: This Foton-owned key uniquely identifies the concrete effect payload.
unsafe impl DowncastType for ApplyStatusEffectsConsumeEffect {
    const TYPE_KEY: DowncastTypeKey =
        DowncastTypeKey::new("foton:consume_effect/apply_status_effects");
}
...
unsafe impl DowncastType for RemoveStatusEffectsConsumeEffect {
    const TYPE_KEY: DowncastTypeKey =
        DowncastTypeKey::new("foton:consume_effect/remove_status_effects");
}
...
unsafe impl DowncastType for ClearAllStatusEffectsConsumeEffect {
    const TYPE_KEY: DowncastTypeKey =
        DowncastTypeKey::new("foton:consume_effect/clear_all_status_effects");
}
...
unsafe impl DowncastType for TeleportRandomlyConsumeEffect {
    const TYPE_KEY: DowncastTypeKey =
        DowncastTypeKey::new("foton:consume_effect/teleport_randomly");
}
...
unsafe impl DowncastType for PlaySoundConsumeEffect {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:consume_effect/play_sound");
}
