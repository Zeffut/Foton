...
//! loot condition machinery here, and so does Foton -- but the loot version in
...
//! Evaluation lives in `foton-core`, where the world is reachable.
//!
...
/// open-ended. Foton models exactly the three keys vanilla data uses; the
