...
use foton_utils::nbt::{NbtNumeric as _, nbt_collection_values};
...
mod tests {
    ...
    fn persistent_codec_accepts_numeric_collections_and_rgb_vectors() {
        ...
        compound.insert("strings", NbtList::String(vec!["foton".into()]));
        compound.insert(
            "colors",
