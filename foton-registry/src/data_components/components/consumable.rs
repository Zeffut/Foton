...
mod tests {
    ...
    where
        T: Clone
            ...
            + simdnbt::ToNbtTag
            + simdnbt::FromNbtTag
            + foton_utils::serial::WriteTo
            + foton_utils::serial::ReadFrom,
    {
    ...
    fn extracted_consumables_keep_typed_effects_and_round_trip() {
        ...
        let golden_apple = REGISTRY
            .items
            .by_key(&foton_utils::Identifier::vanilla_static("golden_apple"))
        ...
        let milk = REGISTRY
            .items
            .by_key(&foton_utils::Identifier::vanilla_static("milk_bucket"))
        ...
        let honey = REGISTRY
            .items
            .by_key(&foton_utils::Identifier::vanilla_static("honey_bottle"))
    ...
    fn extracted_totem_death_protection_round_trips() {
        ...
        let totem = REGISTRY
            .items
            .by_key(&foton_utils::Identifier::vanilla_static("totem_of_undying"))
        ...
        assert!(
            Consumable::new(
                ...
                crate::sound_event::SoundEventHolder::Direct {
                    sound_id: foton_utils::Identifier::vanilla_static("test"),
                    fixed_range: None,
                },
                true,
                Vec::new(),
