...
impl EntityData {
    ...
    /// Reads vanilla's `{id: <entity type>, ...}` shape.
    #[must_use]
...
mod tests {
    ...
    fn entity_data_separates_type_from_payload_on_the_network() {
        ...
        let pig = REGISTRY
            .entity_types
            .by_key(&foton_utils::Identifier::vanilla_static("pig"))
    ...
    fn block_entity_data_uses_the_block_entity_registry() {
        ...
        let chest = REGISTRY
            .block_entity_types
            .by_key(&foton_utils::Identifier::vanilla_static("chest"))
    ...
    fn extracted_spawn_eggs_use_typed_empty_entity_data() {
        ...
        let egg = REGISTRY
            .items
            .by_key(&foton_utils::Identifier::vanilla_static("pig_spawn_egg"))
        ...
        assert_eq!(
            ...
            foton_utils::Identifier::vanilla_static("pig")
        );
