...
impl_predicate_downcast_type!(DamagePredicate, "foton:data_component_predicate/damage");
...
impl_predicate_downcast_type!(
    ...
    "foton:data_component_predicate/enchantments"
);
...
impl_predicate_downcast_type!(
    ...
    "foton:data_component_predicate/stored_enchantments"
);
...
impl_predicate_downcast_type!(
    PotionsPredicate,
    "foton:data_component_predicate/potion_contents"
);
...
impl_predicate_downcast_type!(
    CustomDataPredicate,
    "foton:data_component_predicate/custom_data"
);
...
impl_predicate_downcast_type!(
    ContainerPredicate,
    "foton:data_component_predicate/container"
);
...
impl_predicate_downcast_type!(
    BundlePredicate,
    "foton:data_component_predicate/bundle_contents"
);
