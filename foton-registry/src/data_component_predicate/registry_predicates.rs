...
impl_predicate_downcast_type!(TrimPredicate, "foton:data_component_predicate/trim");
...
impl_predicate_downcast_type!(
    ...
    "foton:data_component_predicate/jukebox_playable"
);
...
impl_predicate_downcast_type!(
    ...
    "foton:data_component_predicate/villager_variant"
);
