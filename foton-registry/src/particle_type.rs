...
// SAFETY: This Foton-owned key uniquely identifies the concrete particle payload.
unsafe impl DowncastType for SimpleParticleOptions {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/simple");
}
...
unsafe impl DowncastType for BlockParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/block");
}
...
unsafe impl DowncastType for ColorParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/color");
}
...
unsafe impl DowncastType for DustParticleOptions {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/dust");
}
...
unsafe impl DowncastType for DustColorTransitionOptions {
    const TYPE_KEY: DowncastTypeKey =
        DowncastTypeKey::new("foton:particle_options/dust_color_transition");
}
...
unsafe impl DowncastType for GeyserParticleOptions {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/geyser");
}
...
unsafe impl DowncastType for GeyserBaseParticleOptions {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/geyser_base");
}
...
unsafe impl DowncastType for PowerParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/power");
}
...
unsafe impl DowncastType for SpellParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/spell");
}
...
unsafe impl DowncastType for ItemParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/item");
}
...
unsafe impl DowncastType for SculkChargeParticleOptions {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/sculk_charge");
}
...
unsafe impl DowncastType for ShriekParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/shriek");
}
...
unsafe impl DowncastType for TrailParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/trail");
}
...
unsafe impl DowncastType for VibrationParticleOption {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("foton:particle_options/vibration");
}
...
mod tests {
    ...
    use foton_utils::codec::VarInt;
    use foton_utils::serial::{ReadFrom, WriteTo};
    use foton_utils::{ArgbColor, BlockPos, BlockStateId, Identifier, RgbColor};
    use glam::DVec3;
