...
pub(crate) mod s_set_command_block;
...
pub use c_boss_event::{
    BossBarColor, BossBarOverlay, BossBarProperties, BossEventOperation, CBossEvent,
};
...
pub use s_set_command_block::{MAX_COMMAND_LENGTH, SSetCommandBlock};
