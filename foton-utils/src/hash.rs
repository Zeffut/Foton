...
///
/// ```
/// use foton_utils::hash::ComponentHasher;
///
...
mod tests {
    ...
    #[test]
    fn test_text_component_plain_string() {
        use text_components::TextComponent;

        // A simple text component with just "Steel" should collapse to a string.
        // The literal is the exact input the reference hash below was taken for;
        // changing it invalidates the constant.
