...
impl Identifier {
    ...
    /// The Foton namespace.
    pub const FOTON_NAMESPACE: &'static str = "foton";
    ...
    /// Creates a new `Identifier` with the Foton namespace.
    #[must_use]
    pub fn from_foton(path: impl Into<Cow<'static, str>>) -> Self {
        Self::new(Self::FOTON_NAMESPACE, path)
    }
