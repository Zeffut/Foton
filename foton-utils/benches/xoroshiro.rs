...
use foton_utils::random::{PositionalRandom, Random, name_hash::NameHash, xoroshiro::Xoroshiro};
use std::hint::black_box;

fn bench_from_seed(c: &mut Criterion) {
    c.bench_function("xoroshiro from_seed", |b| {
        b.iter(|| {
            black_box(Xoroshiro::from_seed(black_box(12345)));
        });
    });
}
...
fn bench_next_i32(c: &mut Criterion) {
    ...
    c.bench_function("xoroshiro next_i32", |b| {
        b.iter(|| {
...
fn bench_next_bounded_i32(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro next_bounded_i32(100)", |b| {
        b.iter(|| {
...
fn bench_next_bool(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro next_bool", |b| {
        b.iter(|| {
...
fn bench_next_f32(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro next_f32", |b| {
        b.iter(|| {
...
fn bench_next_gaussian(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro next_gaussian", |b| {
        b.iter(|| {
...
fn bench_split(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro split", |b| {
        b.iter(|| {
            black_box(rng.fork());
        });
    });
...
fn bench_next_splitter(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    c.bench_function("xoroshiro next_splitter", |b| {
        b.iter(|| {
...
fn bench_split_pos(c: &mut Criterion) {
    ...
    c.bench_function("xoroshiro splitter split_pos", |b| {
        b.iter(|| {
...
fn bench_split_u64(c: &mut Criterion) {
    let mut rng = Xoroshiro::from_seed(0);
    let splitter = rng.next_positional();
    c.bench_function("xoroshiro splitter split_u64", |b| {
        b.iter(|| {
...
fn bench_sequential_generation(c: &mut Criterion) {
    c.bench_function("xoroshiro 1000 next_i32 calls", |b| {
        b.iter(|| {
            let mut rng = Xoroshiro::from_seed(black_box(0));
            for _ in 0..1000 {
                black_box(rng.next_i32());
            }
        });
