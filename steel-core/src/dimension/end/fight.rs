...
//! its constructor and ticks before its entities. Steel keeps it on
...
pub struct EnderDragonFight {
    ...
    /// a bar of its own in vanilla, and does not in Steel either: membership is
    ...
    /// its ticket set collapse the duplicates. Steel's ticket store keeps one
...
impl EnderDragonFight {
    ...
    fn spawn_exit_portal(&self, world: &Arc<World>, activated: bool) {
        ...
        // portal unlit. Steel has no such hold, and the podium is a live block
