...
impl AllayEntity {
    ...
    ///
    /// Vanilla builds them in the constructor from `this`. Steel cannot: the
...
impl Entity for AllayEntity {
    ...
    /// Vanilla parity: `Allay.considersEntityAsAlly`, which Steel reaches
...
impl LivingEntity for AllayEntity {
    ...
    /// hand is equipment, which Steel already drops through
...
impl Mob for AllayEntity {
    ...
    // being dragged back. Steel's leash has no such seam, so a leashed allay
