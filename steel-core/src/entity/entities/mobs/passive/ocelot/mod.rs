...
use steel_registry::{REGISTRY, TaggedRegistryExt, sound_events, vanilla_entities};
...
impl OcelotEntity {
    ...
    /// goal as trust changes. Steel registers it once with the trust checks the
    ...
    fn register_goals(&self) {
        ...
        // turtles. Steel has no turtle yet.
    }
...
impl Mob for OcelotEntity {
    ...
    fn check_spawn_rules(
        ...
        // position below sea level or off grass and leaves. Steel has no
