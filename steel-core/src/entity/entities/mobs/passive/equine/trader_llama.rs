...
// SAFETY: This key is owned by Steel and uniquely identifies `TraderLlamaEntity`.
...
impl TraderLlamaEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        }
        {
            ...
            // `AbstractIllager`. Steel has neither the wandering trader nor the
    ...
    /// trader; Steel has no wandering trader, so any leash counts.
