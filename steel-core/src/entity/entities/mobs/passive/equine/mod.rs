...
//! they are grouped the way vanilla groups them rather than split across Steel's
...
use steel_registry::vanilla_entity_data::{VanillaEntityData, VanillaLivingEntityData};
...
///
/// Vanilla parity: the `LivingEntity.tick` effect sync. Every Steel mob repeats
