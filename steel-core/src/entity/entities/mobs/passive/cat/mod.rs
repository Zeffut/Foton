...
use steel_registry::cat_sound_variant::{CatAge, CatSoundVariantRef};
use steel_registry::cat_variant::CatVariantRef;
...
use steel_registry::{DyeColor, REGISTRY, RegistryExt, RegistryReference, TaggedRegistryExt};
...
// SAFETY: This key is owned by Steel and uniquely identifies `CatEntity`.
...
impl CatEntity {
    ...
    /// the cat is tamed. Steel registers it once with the same tame checks the
    ...
    fn register_goals(&self) {
        ...
        // rabbits and land-bound baby turtles. Neither mob exists in Steel yet,
