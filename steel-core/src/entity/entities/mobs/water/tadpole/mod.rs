...
use steel_registry::{REGISTRY, TaggedRegistryExt as _, sound_events, vanilla_entities};
...
// SAFETY: This key is owned by Steel and uniquely identifies `TadpoleEntity`.
...
impl Mob for TadpoleEntity {
    ...
    /// `Bucketable.bucketMobPickup` and to the golden-dandelion age lock. Steel's
