...
// SAFETY: This key is owned by Steel and uniquely identifies `IllusionerEntity`.
...
///
/// Vanilla parity: `Illusioner.performRangedAttack`. Steel's arrow already
...
/// quiver; Steel's mobs have none, so the arrow is a plain one.
...
impl Mob for IllusionerEntity {
    ...
    /// it is in no biome's spawn list -- but the rule is registered and Steel
