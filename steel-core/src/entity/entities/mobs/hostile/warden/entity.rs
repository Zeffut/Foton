...
//! [`VibrationListener`], which is why it could not exist in Steel before the vibration
...
// SAFETY: This key is owned by Steel and uniquely identifies `WardenEntity`.
...
impl WardenEntity {
    ...
    ///
    /// Not implemented: the world-border bounds check. Steel's border is reachable from
