...
use crate::entity::ai::goal::{
    ...
    NearestAttackableTargetGoal, RaiderCelebrationGoal, WaterAvoidingRandomStrollGoal,
};
...
// SAFETY: This key is owned by Steel and uniquely identifies `RavagerEntity`.
...
impl RavagerEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            // Vanilla also adds three raid-only goals. Steel has no raid.
        }

        {
            ...
            // Vanilla also hunts adult villagers at priority 4; Steel has none.
        }
...
///
/// Vanilla tests `block instanceof LeavesBlock`; Steel reads the block tag,
