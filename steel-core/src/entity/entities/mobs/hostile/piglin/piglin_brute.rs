...
use steel_registry::{sound_events, vanilla_entities, vanilla_items, vanilla_mob_effects};
...
// SAFETY: This key is owned by Steel and uniquely identifies `PiglinBruteEntity`.
