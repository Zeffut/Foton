...
/// which the piglin uses four times. Steel has no declarative builder -- see
...
/// and its fight activity the three `Spear*` behaviors. Steel has no
...
///
/// Steel's targeting conditions carry the line-of-sight test, so the ignoring
