...
//!   from the heart, which keeps a creaking near its tree. Steel's navigation
...
// SAFETY: This key is owned by Steel and uniquely identifies `CreakingEntity`.
...
impl CreakingEntity {
    ...
    /// it still is.
    ///
    /// Vanilla holds the `CreakingHeartBlockEntity` directly; Steel's block
