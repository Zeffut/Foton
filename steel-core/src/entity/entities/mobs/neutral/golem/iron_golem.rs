...
use steel_utils::{BlockPos, BlockStateId, Downcast, DowncastType, DowncastTypeKey, UuidExt as _};
use uuid::Uuid;
...
// SAFETY: This key is owned by Steel and uniquely identifies `IronGolemEntity`.
...
impl IronGolemEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            // distance tracker and villagers, neither of which Steel has.
