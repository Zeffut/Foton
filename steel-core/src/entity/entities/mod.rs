...
pub use mobs::passive::{
    ...
    MushroomCowEntity, NautilusEntity, OcelotEntity, PandaEntity, PandaGene, ParrotEntity,
    ...
    ZombieHorseEntity, ZombieNautilusEntity, hatch_sniffer_from_egg, spawn_allay,
};
pub use mobs::water::{
