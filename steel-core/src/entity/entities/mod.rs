...
pub use mobs::passive::{
    ...
    MuleEntity, MushroomCowEntity, NautilusEntity, OcelotEntity, PandaEntity, PandaGene,
    ...
    TurtleEntity, ZombieHorseEntity, ZombieNautilusEntity, hatch_sniffer_from_egg, spawn_allay,
};
pub use mobs::water::{
