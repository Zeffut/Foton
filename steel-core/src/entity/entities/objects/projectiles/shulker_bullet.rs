...
use steel_registry::vanilla_entity_data::ShulkerBulletEntityData;
use steel_registry::{
...
use steel_utils::{BlockPos, ChunkPos, Direction, DowncastType, DowncastTypeKey, UuidExt};
use uuid::Uuid;
...
// SAFETY: This key is owned by Steel and uniquely identifies `ShulkerBulletEntity`.
unsafe impl DowncastType for ShulkerBulletEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("steel:entity/shulker_bullet");
}
...
impl ShulkerBulletEntity {
    ...
    ///
    /// Vanilla parity: `LevelReader.loadedAndEntityCanStandOn`. Steel checks the
...
impl Entity for ShulkerBulletEntity {
    ...
    fn tick(&self) {
        ...
        // TODO: vanilla also runs `handlePortal` here; Steel's projectiles do
...
impl Projectile for ShulkerBulletEntity {
    ...
    fn on_hit_entity(&self, entity: &SharedEntity, _location: DVec3) {
        ...
        // TODO: vanilla also runs `EnchantmentHelper.doPostAttackEffects`; Steel
