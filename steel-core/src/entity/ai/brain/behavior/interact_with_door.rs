...
use steel_utils::{BlockPos, BlockStateId, GlobalPos};
...
/// set and mutates it in place; Steel reads and writes the memory here, so both
...
/// datapack that puts something else there, and nothing in Steel can observe
