...
use steel_registry::{sound_events, vanilla_blocks, vanilla_menu_types};
...
// within the process.
unsafe impl steel_utils::DowncastType for CartographyKind {
    const TYPE_KEY: steel_utils::DowncastTypeKey =
        steel_utils::DowncastTypeKey::new("steel:menu/cartography_table");
}
