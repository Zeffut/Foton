...
use steel_registry::banner_pattern::BannerPatternRef;
...
use steel_registry::vanilla_banner_pattern_tags::BannerPatternTag;
...
///
/// Vanilla parity: the `instanceof BannerItem` of `LoomMenu`. Steel has no
