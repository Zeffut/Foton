...
unsafe impl DowncastType for CommandBlockEntity {
    const TYPE_KEY: DowncastTypeKey = DowncastTypeKey::new("steel:block_entity/command_block");
}
...
impl CommandBlockEntity {
    ...
    fn evaluate_condition(&self) -> bool {
        ...
        world
            ...
            .and_then(|entity| {
                steel_utils::Downcast::downcast_ref::<Self>(entity.as_ref())
    ...
    ///
    /// Vanilla re-reads the world here. Steel reads the state this block entity
