...
use steel_registry::level_events::SOUND_BREWING_STAND_BREW;
use steel_registry::{potion_brewing, vanilla_block_entity_types, vanilla_items};
...
/// As with the furnace, vanilla hands the menu the block entity itself; Steel
...
#[cfg(test)]
mod tests {
    use steel_registry::potion_brewing::potion_item;
