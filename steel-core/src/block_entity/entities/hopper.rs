...
impl HopperBlockEntity {
    ...
    /// vanilla repeats here is not reproduced: Steel only reaches this from the
...
///
/// Vanilla mutates the stack it never really detached; Steel took a real copy
...
mod tests {
    ...
    /// The count goes back onto whatever is left in the slot, because Steel
