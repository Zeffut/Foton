...
use steel_utils::{BlockPos, BlockStateId, Direction, DowncastType, DowncastTypeKey, WorldAabb};
...
struct BellState {
    ...
    /// list from a chunk, so Steel caches ids and resolves them again, the way
