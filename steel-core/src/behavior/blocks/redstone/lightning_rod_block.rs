...
///
/// Vanilla does `stateBelow.getBlock() instanceof LightningRodBlock`, and Steel
...
impl LightningRodBlock {
    ...
    /// `ExperimentalRedstoneUtils.initialOrientation`; Steel's neighbor updater
...
impl BlockBehavior for WeatheringLightningRodBlock {
    ...
    ///
    /// Vanilla's `isRandomlyTicking` stops at the oxidized stage; Steel keeps
