...
pub use building::{
    ...
    InfestedRotatedPillarBlock, IronBarsBlock, JigsawBlock, LadderBlock, LavaCauldronBlock,
    ...
    SpongeBlock, StairBlock, StructureBlock, TrapDoorBlock, WallBlock, WaterloggedTransparentBlock,
