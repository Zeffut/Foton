...
impl ItemBehavior for WindChargeItem {
    ...
    /// Steel does the same: `use_item` applies the stack's
    ...
    /// event; Steel has no `ProjectileItem` dispense hook to hang that on.
    fn use_item(&self, context: &mut UseItemContext) -> InteractionResult {
        ...
        // first here rather than being lost to a spawn Steel could not complete.
