...
use steel_registry::data_components::components::{MapDecorations, MapId, MapPostProcessing};
use steel_registry::data_components::vanilla_components::{
    MAP_DECORATIONS, MAP_ID, MAP_POST_PROCESSING,
};
use steel_registry::equipment::{EquipmentSlot, EquipmentSlotType};
use steel_registry::item_stack::ItemStack;
use steel_registry::map_color::{Brightness, MapColor};
use steel_registry::vanilla_block_tags::BlockTag;
use steel_registry::{REGISTRY, sound_events, vanilla_blocks, vanilla_items};
...
impl ItemBehavior for MapItem {
    ...
    /// `Slot.onTake`, which hands the taken stack to the item; Steel's
...
impl ItemBehavior for EmptyMapItem {
    ...
    /// spent, and otherwise adds it to the inventory. Steel has no
...
/// into another dimension is still resolvable. Steel looks them up by UUID
...
pub fn tick_carried_by(
    ...
    // on stack identity, and Steel has lifted the stack out of the slot for the
...
/// has to. Steel skips columns whose chunk is not loaded rather than driving
