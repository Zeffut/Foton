...
//!
//! Vanilla parity: `HangingEntityItem`. Steel maps only the painting to this
...
use steel_registry::data_components::vanilla_components::PAINTING_VARIANT;
...
impl ItemBehavior for HangingEntityItem {
    ...
    fn use_on(&self, context: &mut UseOnContext) -> InteractionResult {
        ...
        // `Player.mayUseItemAt`, has no counterpart -- Steel has no
        ...
        // inventory put the stack back. Steel has no such restore, so the
